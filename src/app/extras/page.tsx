...
export default function ExtrasPage() {
  ...
  const extras = [
    {
      icon: Coffee,
      title: t('extras.breakfastTitle'),
      description: t('extras.breakfastDesc'),
      price: t('extras.breakfastPrice'),
      items: t('extras.breakfastItems'),
      color: 'cygne-gold'
    },
    {
      icon: Wine,
      title: t('extras.drinksTitle'),
      description: t('extras.drinksDesc'),
      items: [
        t('extras.wineSelection'),
        t('extras.cremant'),
        t('extras.softDrinks')
      ].join(' • '),
      color: 'cygne-brown'
  ...
  const services = [
    {
      icon: ConciergeBell,
      title: t('extras.concierge'),
      description: t('extras.conciergeDesc')
    },
    {
      icon: Sparkles,
      title: t('extras.cleaning'),
      description: t('extras.cleaningDesc')
    },
    {
      icon: Car,
      title: t('extras.transfer'),
      description: t('extras.transferDesc')
    }
  ];
    ...
    <div className="bg-cygne-cream min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-6">
                  <div className={`p-4 bg-${extra.color}/10 rounded-lg`}>
                    <Icon className={`text-${extra.color}`} size={32} />
                  </div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-4xl font-serif text-cygne-brown mb-4 text-center">
            {t('extras.servicesTitle')}
          </h2>
          <p className="text-cygne-brown/70 text-center mb-12 max-w-2xl mx-auto">
            {t('extras.servicesDesc')}
          </p>
        ...
        >
          <h2 className="text-3xl font-serif mb-4">{t('extras.bookExtras')}</h2>
          <p className="text-white/80 mb-8 max-w-2xl mx-auto leading-relaxed">
            {t('extras.bookExtrasDesc')}
          </p>
